...
namespace ConsultorioMedAPP.Controllers
{
    public class GeneroesController : Controller
    {
        ...
        public GeneroesController(ConsultorioMedDBContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdGenero,Descripcion,Activo")] Genero genero)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdGenero,Descripcion,Activo")] Genero genero)
        {
